...
public class GreetingController {
    ...
    //Create a method editGreetingMessage to replace the greeting message by new greeting message and call the method of GreetingService class
    @PutMapping("/replace/{id}")
    public Optional<Greeting> editGreetingMessage(@PathVariable Long id,@RequestBody String newMassage){
        return greetingService.editGreetingMessage(id,newMassage);
    }

    //Create a method deleteGreetingMessageById to delete the greeting message by id number and call the method of GreetingService class
    @DeleteMapping("/{id}")
    public boolean deleteGreetingMessageById(@PathVariable Long id){
        return greetingService.deleteGreetingMessage(id);
    }
